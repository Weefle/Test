...
public class FileManager
{
    ...
    throws FileNotFoundException, IOException
  {
    ...
    l = Integer.valueOf(l.intValue() - 1);
    List<String> sss = new ArrayList();
    BufferedReader br = new BufferedReader(new FileReader(file));Throwable localThrowable2 = null;
    try
    {
      String line;
      while ((line = br.readLine()) != null) {
    ...
    if (fileExists(file))
    {
      ...
      try
      {
        if (overwrite.booleanValue() == true) {
          output = new BufferedWriter(new FileWriter(file, overwrite.booleanValue()));
        } else {
